    ...
    init(content) {
        return Promise.resolve().then(() => {
            ...
            switch(this.contentType) {
                case "text/css": return this.compressCss(content);
                case "application/javascript": return this.compressJs(content);
                case "text/html": return this.compressHtml(content);
                default: return content;
            }
        }).then(bundle => {
            this.content = bundle;   
            return this.compressStream();
        });
    };
    ...
    initFromFiles(filepathList) {
        return Promise.resolve().then(() => {
            ...
            switch(this.contentType) {
                ...
                case "application/javascript": return this.getBundle(filepathList, { ext: ".js", encoding: "utf8" });
                case "text/html": return this.getBundle(filepathList, { ext: ".html", encoding: "utf8" });
